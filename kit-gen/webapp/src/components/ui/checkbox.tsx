...
>(({ className, ...props }, ref) => (
  <CheckboxPrimitive.Root
    ref={ref}
    className={cn(
      "peer inline-flex size-5 shrink-0 items-center justify-center rounded-1 border border-line bg-raised p-0 text-transparent transition-colors duration-fast",
