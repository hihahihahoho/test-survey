/**
 * features/kit-core/lib/idb.ts — CỬA DUY NHẤT tới IndexedDB (architecture §4.2).
 * 08/09/2026 đổi nhà từ `features/design/safety/`; người dùng còn lại: `settings/PrefsTab`.
 *
