/* BẢNG ĐÃ ĐÓNG BĂNG — ĐỪNG SỬA TAY, VÀ KHÔNG CÒN CÁCH NÀO SINH LẠI.
 * Sinh ra một lần bởi `features/design/scripts/extract-shapes.mjs` từ silhouettes.js ·
 * skeleton.py · agent/lib/validate.mjs · slice.py · styles.example.json. Đợt 2 xoá script
 * đó vì hai nguồn của nó (silhouettes.js, skeleton.py) không còn tồn tại — bảng ở lại như
 * một hằng số chép tay, và `__tests__/shape-source.test.ts` canh nó với những nguồn CÒN
 * SỐNG. Muốn đổi hình khối thì sửa thẳng ở đây và sửa ca test cùng lúc.
 */
