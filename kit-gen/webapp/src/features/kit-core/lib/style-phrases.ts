...
/* 08/09/2026 — đổi nhà từ `features/kit-form/lib/`; `sliderValueText()` (chữ a11y của
   thanh trượt trong form 4 trang) đi cùng form bị xoá. Ba hàm còn lại dựng CÂU PROMPT,
   và câu prompt thì không chết theo màn: `kit-core/lib/kitset-to-contract` và
   `prompt-canvas/lib/composer-to-contract` đang gọi chúng. */
