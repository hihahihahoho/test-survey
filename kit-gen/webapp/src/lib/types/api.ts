 ...
 */
/**
 * MỘT ẢNH THAM CHIẾU CỦA TẤM, KÈM VAI CỦA NÓ.
 *
 * `attachments` là một cột đường dẫn trần: bày được tấm ảnh nhưng không nói được
 * tấm nào là ảnh nhân vật, tấm nào là ảnh dáng, tấm nào là logo. Vai do ENGINE
 * khai ra trong `prompts/<job>.refs` rồi agent đọc lại — webapp không suy lại thứ
 * tự ấy, vì engine trên máy người dùng cập nhật bằng một lượt riêng với webapp.
 */
